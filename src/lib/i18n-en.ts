...
export const EN_DICT: Record<string, string> = {
  ...
  "{count} 条余额记录": "{count} balance records",
  "更早记录": "Older Records",
  "目标设备": "Target Device",
  "已接受": "Accepted",
  "事件": "Event",
  ...
  "余额查询": "Balance Query",
  "查询": "Query",
  "使用当前设备的运营商规则发送 USSD 或短信查询，结果会写入余额历史。":
    "Use the current device's carrier rule to send a USSD or SMS query; results are written to balance history.",
  ...
  "异步": "Async",
  "运营商已返回结果": "Carrier returned a result",
  "查询已发送，正在等待运营商回复": "Query sent; waiting for the carrier reply",
  // 查询中心。
  "查询中心": "Query Center",
  "卡与 Profile": "Cards & Profiles",
  ...
  "较上次{direction} {change}": "{direction} {change} vs. last query",
  "增加": "up",
  "减少": "down",
  "查询中…": "Querying…",
  "立即查询": "Query Now",
  "查询已提交": "Query submitted",
  "查询失败：": "Query failed: ",
  "余额历史": "Balance History",
  "余额历史加载失败": "Failed to load balance history",
  "配置自动查询计划 →": "Set up auto-query plan →",
  "还没有查询记录，点击「立即查询」发起一次余额查询": "No queries yet. Click Query Now to start one",
  "前次": "previous",
  "自定义配置": "Custom",
  "系统默认": "System defaults",
  "恢复默认": "Reset to defaults",
  "恢复默认失败：": "Failed to reset to defaults: ",
  "已恢复默认卡资料": "Card resources reset to defaults",
  "卡资料已保存": "Card resources saved",
  "卡资料加载失败：": "Failed to load card resources: ",
  "卡资料保存失败：": "Failed to save card resources: ",
  "充值链接": "Recharge link",
  "打开充值链接": "Open recharge link",
  "续费链接": "Renewal link",
  "打开续费链接": "Open renewal link",
  "充值链接必须是有效的 HTTP(S) 地址": "Recharge link must be a valid HTTP(S) URL",
  "续费链接必须是有效的 HTTP(S) 地址": "Renewal link must be a valid HTTP(S) URL",
  "知识库条目标题不能为空": "Knowledge link title cannot be empty",
  "知识库链接必须是有效的 HTTP(S) 地址": "Knowledge link must be a valid HTTP(S) URL",
  "暂无知识库链接，点击下方按钮新增": "No knowledge links yet. Use the button below to add one",
  "新增知识库链接": "Add knowledge link",
  "标题": "Title",
  "上移": "Move up",
  "下移": "Move down",
  "打开链接": "Open link",
  "配置按 ICCID/Profile 保存，仅影响当前卡": "Saved per ICCID/Profile; only affects this card",
  "余额自动查询": "Balance auto query",
  "续费提醒": "Renewal reminder",
  "未知计划": "Unknown plan",
  "实体卡": "Physical SIM",
  "计划加载失败：": "Failed to load plans: ",
  "计划名称": "Plan name",
  "计划名称不能为空": "Plan name cannot be empty",
  "间隔天数（1-365）": "Interval days (1-365)",
  "间隔天数必须在 1-365 之间": "Interval days must be between 1 and 365",
  "开始日期": "Start date",
  "开始日期必须是 YYYY-MM-DD": "Start date must use YYYY-MM-DD",
  "执行时间必须是 HH:MM": "Run time must use HH:MM",
  "时区（IANA）": "Timezone (IANA)",
  "时区不能为空": "Timezone cannot be empty",
  "启用计划": "Enabled",
  "执行结果推送到已启用渠道": "Push results to enabled channels",
  "已有计划": "Existing plans",
  "当前卡还没有计划，使用下方表单创建": "No plans for this card yet. Create one with the form below",
  "新建或编辑计划": "Create or edit plans",
  "到期后自动切换到目标卡并执行一次余额查询，完成后保持目标卡激活并恢复其网络策略。": "When due, switches to the target card and runs one balance query; the target card stays active and its saved network policy is restored afterwards.",
  "到期后仅发送续费/保号提醒通知，不执行查询，也不切换 Profile。": "When due, only a renewal reminder is sent; no query runs and no Profile is switched.",
  "每 {days} 天 · 下次 {next}": "Every {days} days · next {next}",
  "上次执行失败": "Last run failed",
  "上次执行成功": "Last run succeeded",
  "立即执行一次": "Run once now",
  "编辑中": "Editing",
  "创建计划": "Create plan",
  "取消编辑": "Cancel editing",
  "删除这条计划？": "Delete this plan?",
  "删除后该卡将不再自动执行此计划。": "This card will no longer run the plan automatically after deletion.",
  "计划已创建": "Plan created",
  "计划已更新": "Plan updated",
  "计划保存失败：": "Failed to save plan: ",
  "计划删除失败：": "Failed to delete plan: ",
  "已触发「{name}」立即执行一次": "Triggered {name} to run once immediately",
  "触发失败：": "Failed to trigger: ",
  "余额": "Balance",
  "充值/续费": "Recharge / Renewal",
  "知识库": "Knowledge base",
  "计划": "Plans",
  "eUICC": "eUICC",
};
