/**
 * vofly 英文字典：键为源码里的中文原文（完整字符串），值为英文。
...
export const EN_DICT: Record<string, string> = {
	...
	"自动接听": "Auto-answer",
	"VoLTE 来电自动接听": "Auto-answer VoLTE calls",
	"打开设置": "Open settings",
	"选择自动接听 provider": "Choose auto-answer provider",
	"自动接听时使用的任务说明": "Task for auto-answer",
	"身份与自动接听设置已收进右上角的 AI 通话弹窗。": "Identity and auto-answer settings live in the AI Calls dialog in the top-right.",
	"仅在 VoLTE 来电时生效。保存后会影响后端自动接管逻辑。": "Only applies to VoLTE inbound calls. Saving updates backend auto-answer behavior.",
  ...
  预览: "Preview",
  收起: "Collapse",
  "近 5 次执行时间": "Next 5 Runs",
  "请填写有效的首次执行日期、执行时间和执行周期": "Enter a valid first run date, run time and interval",
  ...
  仅连接基站: "Connect to the cellular network only",
  "仅连接基站（不开启漫游流量）": "Connect to the cellular network only (without roaming data)",
  "该任务固定使用基站直连和自动选网；执行时只连接基站，不开启漫游流量。": "This task always uses cellular direct mode with automatic network selection. It only registers on the cellular network and does not enable roaming data.",
  类型: "Type",
  ...
  "启用 MeoW 推送": "Enable MeoW",
  MeoW: "MeoW",
  "MeoW 昵称": "MeoW Nickname",
  "填写 MeoW 中注册的用户昵称，不能包含斜杠。": "Enter the nickname registered in MeoW. Slashes are not allowed.",
  "例如 Sunny": "e.g. Sunny",
  "MeoW 通知测试失败": "MeoW notification test failed",
  ...
  "读取 eSIM 超时": "Reading eSIM timed out",
  "eSIM 信息读取失败": "Failed to read eSIM information",
  "请先尝试重新检测；如果仍失败，可以尝试重启模组。重启模组无效时，请到系统设置中重启 vofly 服务。":
    "Try detecting again first. If it still fails, reboot the modem. If rebooting the modem does not help, restart the vofly service from System Settings.",
  ...
  "AI 通话指标": "AI call metrics",
  "刷新指标": "Refresh metrics",
  "已分析通话": "Analyzed calls",
  ...
  "通话控制已被另一个标签页接管": "Call control has been taken over by another tab",
  "AI 通话": "AI Calls",
  ...
  "AI 外呼": "AI Dial",
  "AI 批量外呼": "AI Batch Dial",
  "AI 接管": "AI Takeover",
  "批量号码": "Batch numbers",
  "每行一个号码，或用逗号分隔": "One number per line, or separate with commas",
  "本地预设管理": "Local preset management",
  "未配置预设文件，需设置 VOFLY_AI_CALL_PRESETS_FILE 或 NUMBER_PROFILES_FILE 后才能保存": "Preset file is not configured. Set VOFLY_AI_CALL_PRESETS_FILE or NUMBER_PROFILES_FILE before saving.",
  "预设 ID": "Preset ID",
  "匹配任务": "Matching task",
  "场景策略": "Scenario strategy",
  "给 AI 的精调场景策略": "Tuned scenario strategy for AI",
  "开场白": "Opening",
  "时长上限（秒）": "Max call length (s)",
  "任务包 JSON": "Task package JSON",
  "例如：{\"verification\":{\"account_pin\":\"1234\"}}": "Example: {\"verification\":{\"account_pin\":\"1234\"}}",
  "接通后的第一句话": "First sentence after connection",
  "AI 建单助手": "AI task intake",
  "生成场景策略": "Generate scenario",
  "套用草稿": "Apply draft",
  "描述你要 AI 代打的事": "Describe the AI call task",
  "AI 已生成开场白": "AI generated opening",
  "任务包已生成": "Task package generated",
  "生成失败": "Generation failed",
  "我": "Me",
  "直接开场": "Say immediately",
  "等待 IVR": "Wait for IVR",
  "结果校验": "Result verification",
  "仅通话记录": "Call transcript only",
  "短信校验": "SMS verification",
  "口述后补按键": "Follow spoken DTMF",
  "启用预设": "Enable preset",
  "保存预设": "Save preset",
  "新建预设": "Create preset",
  "清空表单": "Clear form",
  "确认删除这个预设？": "Delete this preset?",
  "热线情报": "Hotline playbook",
  "热线情报学习": "Hotline playbook learning",
  "学习热线情报": "Learn hotline playbook",
  "未配置热线情报文件": "Hotline playbook file is not configured",
  "已更新热线情报": "Hotline playbook updated",
  "未学习到新情报": "No new playbook knowledge learned",
  "新增必采信息": "New required information",
  "新增 IVR 记录": "New IVR note",
  "必采信息": "Required information",
  "IVR 流程": "IVR flow",
  "批量队列": "Batch queue",
  "待拨 {count} 个": "{count} pending",
  "当前外呼": "Current dial",
  "待拨号码": "Pending numbers",
  "取消待拨": "Cancel pending",
  ...
  "来意": "Intent",
  "紧急程度": "Urgency",
  "是否回电": "Callback needed",
  "高": "High",
  "中": "Medium",
  "低": "Low",
  "智能分诊": "AI triage",
  "转接状态": "Takeover status",
  ...
  "转接失败": "Takeover failed",
  "转接状态未知": "Unknown takeover status",
  "结果核实": "Result Verification",
  "暂无结果核实": "No result verification yet",
  "任务判定": "Task Verdict",
  ...
  "连接中断，浏览器正在自动重连…": "Connection interrupted; the browser is reconnecting automatically…",
  "当前设备：{device}": "Current device: {device}",
  "发送中": "Sending",
  "等待回复": "Awaiting reply",
  "已完成": "Completed",
  "已超时": "Timed out",
  ...
  "切换 eSIM": "Switch eSIM",
  "蜂窝通话": "Cellular Call",
  "切换公网 IP": "Rotate Public IP",
  "Profile 序号或 ICCID": "Profile index or ICCID",
  "电话号码": "Phone Number",
  "秒数": "Seconds",
  "检查并执行": "Review and Run",
  "异步": "Async",
  // 查询中心已拆分：余额历史并入自动任务页，页面重构为知识库。
  "余额无变化": "Balance unchanged",
  "较上次增加": "Increase",
  "较上次减少": "Decrease",
  "卡": "Card",
  "变化": "Change",
  "余额变动历史": "Balance Change History",
  ...
  "协议代理（sing-box）": "Protocol proxies (sing-box)",
  "新增协议代理": "Add protocol proxy",
  "编辑协议代理": "Edit protocol proxy",
  "代理 ID": "Proxy ID",
  "协议 URI": "Protocol URI",
  "可留空，将自动创建": "Leave empty to generate automatically",
  "例如：新加坡节点": "For example: Singapore node",
  "支持 VLESS、VMess、Trojan、Shadowsocks 和 SOCKS5 URI": "Supports VLESS, VMess, Trojan, Shadowsocks, and SOCKS5 URIs",
  "启用协议代理": "Enable protocol proxy",
  "编辑时仅提供新的 URI，原 URI 不会回显": "When editing, enter a new URI; the original URI is never shown",
  "URI 由 sing-box 接管，自动生成 127.0.0.1 SOCKS5 监听": "URIs are managed by sing-box and expose a local 127.0.0.1 SOCKS5 listener",
  "安装 sing-box": "Install sing-box",
  "卸载 sing-box": "Uninstall sing-box",
  "请先安装 sing-box": "Install sing-box first",
  "目标服务器": "Target server",
  "本地 SOCKS5": "Local SOCKS5",
  "由 sing-box 接管": "Managed by sing-box",
  "暂无 sing-box 协议代理": "No sing-box protocol proxies",
  "协议代理已保存": "Protocol proxy saved",
  "协议代理已删除": "Protocol proxy deleted",
  "确定删除协议代理“{name}”吗？其派生 SOCKS5、国家规则和 Profile 绑定也会删除。": "Delete protocol proxy “{name}”? Its derived SOCKS5 route, country rules, and Profile bindings will also be removed.",
  "由 sing-box 接管，只读派生": "Managed by sing-box; derived and read-only",
  "请输入受支持的代理 URI": "Enter a supported proxy URI",
  "切换协议代理状态失败": "Failed to change protocol proxy state",
  "sing-box 状态加载失败": "Failed to load sing-box status",
  "依赖操作失败": "Dependency operation failed",
  "依赖任务超时": "Dependency job timed out",
  "依赖任务失败": "Dependency job failed",
  "依赖状态加载失败": "Failed to load dependency status",
  "依赖任务状态加载失败，正在重试": "Could not load the dependency job; retrying",
  "检查已安装软件包": "Checking installed packages",
  "下载官方安装脚本": "Downloading the official installer",
  "安装组件": "Installing component",
  "卸载组件": "Uninstalling component",
  "记录安装状态": "Recording installed packages",
  "管理 PC/SC 服务": "Managing the PC/SC service",
  "任务结束": "Job finished",
  "处理中": "Running",
  "由 vofly 管理": "Managed by vofly",
  "系统已有，非 vofly 管理": "Already installed outside vofly",
  "任务 ID": "Job ID",
  "开始时间": "Started",
  "结束时间": "Finished",
  ...
  "最后执行命令": "Last command",
  "命令输出": "Command output",
  "仅显示最近 32 KB 输出": "Showing the latest 32 KB of output",
  "等待命令输出": "Waiting for command output",
  "命令未产生输出": "The command produced no output",
  "可选组件": "Optional components",
  "当前系统没有可用的包管理器": "No supported package manager is available",
  "确认卸载可选组件": "Confirm optional component uninstall",
  "确定卸载 {name} 吗？": "Uninstall {name}?",
  "可选组件管理": "Optional component management",
  "按需安装和卸载额外运行组件": "Install and uninstall extra runtime components as needed",
  "返回系统设置": "Back to system settings",
  "管理可选组件": "Manage optional components",
  "管理依赖": "Manage dependencies",
  "管理": "Manage",
  "已安装 {count} 项": "{count} installed",
  "状态待检查": "Status pending",
  "暂无可选组件": "No optional components",
  "已安装": "Installed",
  "未安装": "Not installed",
  "组件安装完成": "Component installed",
  "组件卸载完成": "Component uninstalled",
  "路径": "Path",
  "可选组件由系统包管理器按需安装；卸载只会移除由 vofly 记录的组件。":
    "Optional components are installed by the system package manager; uninstall only removes components recorded by vofly.",
  "用于 USB SIM 读卡器和 CCID 设备": "For USB SIM readers and CCID devices",
