...
export const EN_DICT: Record<string, string> = {
  ...
  "{count} 条命令事件": "{count} command events",
  "{count} 条余额记录": "{count} balance records",
  "更早记录": "Older Records",
  "清除历史": "Clear History",
  "目标设备": "Target Device",
  "命令会在后端串行写入事件，页面通过 SSE 自动追踪结果。":
    "Commands write events on the backend; this page tracks results automatically over SSE.",
  "命令历史": "Command History",
  "暂无命令事件": "No command events",
  "已接受": "Accepted",
  "事件": "Event",
  "输入 /help、/status 或 /balance；Enter 执行，Shift+Enter 换行":
    "Enter /help, /status, or /balance; Enter runs, Shift+Enter inserts a newline",
  "快捷键：Enter 或 Ctrl+Enter 执行；Shift+Enter 换行。高风险命令会二次确认。":
    "Shortcuts: Enter or Ctrl+Enter to run; Shift+Enter for a newline. High-risk commands require confirmation.",
  "执行": "Run",
  "余额查询": "Balance Query",
  "查询": "Query",
  ...
  "快捷动作会生成 slash 命令并弹出确认框，实际执行仍走命令中心后端。":
    "Shortcuts generate slash commands and show a confirmation dialog; execution still goes through the command-center backend.",
  "命令目录": "Command Catalog",
  "暂无命令定义": "No command definitions",
  "高风险": "High risk",
  "异步": "Async",
  "命令中心已刷新": "Command center refreshed",
  "只清除已完成和失败的记录，进行中的命令会保留。":
    "Only completed and failed records are cleared; running commands are kept.",
  "清除命令历史": "Clear Command History",
  "已清除 {count} 条执行记录": "Cleared {count} execution records",
  "确认执行高风险命令": "Confirm High-Risk Command",
  "快捷动作参数无效": "Shortcut parameters are invalid",
  "运营商已返回结果": "Carrier returned a result",
  "查询已发送，正在等待运营商回复": "Query sent; waiting for the carrier reply",

  // ---- 查询中心 ----
  查询中心: "Query Center",
  "卡 / Profile": "Card / Profile",
  "选择左侧卡片后，在右侧查看余额、充值续费和卡资料。":
    "Select a card on the left to view balance, recharge/renewal, and card resources on the right.",
  "暂无可用 SIM / Profile": "No available SIM / Profile",
  当前卡片: "Current card",
  "未选择卡或 Profile": "No card or Profile selected",
  "选择后显示余额、充值续费和卡资料": "Select one to show balance, recharge/renewal, and card resources",
  "实体 SIM": "Physical SIM",
  余额: "Balance",
  充值续费: "Recharge & Renewal",
  "请选择左侧的卡或 Profile": "Select a card or Profile on the left",
  "按所选卡/Profile 查询并展示余额历史。": "Query and show balance history for the selected card/Profile.",
  立即查询: "Query now",
  查询已提交: "Query submitted",
  "变化：{amount}": "Change: {amount}",
  "维护充值、续费链接，并创建卡级提醒计划。":
    "Maintain recharge and renewal links, and create card-level reminder plans.",
  充值链接: "Recharge link",
  续费链接: "Renewal link",
  保存卡资料: "Save card resources",
  卡资料已保存: "Card resources saved",
  新增续费提醒: "Add renewal reminder",
  打开充值: "Open recharge",
  打开续费: "Open renewal",
  提醒计划: "Reminder plans",
  暂无充值续费提醒: "No recharge/renewal reminders",
  充值续费提醒: "Recharge/renewal reminder",
  充值续费提醒已创建: "Recharge/renewal reminder created",
  "{days} 天": "{days} days",
  "下次：{time}": "Next: {time}",
};
