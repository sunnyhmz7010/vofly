...
| 2026-09-06 | 核对至 4760e33 | 核对 96a1233..4760e33 共 4 个提交：4760e33（上游 workflow/BuildKit 脚本）与 aa00c32（上游多语言 README）不适用；152da09（FIX #120）与 e7bbdef（#119）均为纯后端提交，无 web 改动，后端侧已在 vofly-backend 移植（a1abc03）。本次无代码改动 | — |
| 2026-09-24 | 核对至 484cd23（#136） | 核对 4760e33..484cd23 共 16 个提交，其中涉及 web/ 的为 #126、#128、FIX #129、#133。#126 的自动清理设置、#128 的 MTU 设置与 #133 的每卡 MBN 已于 b2bd697 移植；本次补齐 #126 的短信存储占用展示。FIX #129 的旧版高级任务门控在本仓已不存在，维持本地任务规则。#136/#137 为纯后端改动，由 vofly-backend 同步。 | 本行所在提交 |
